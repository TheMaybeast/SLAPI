...
internal static class GameOffsets
{
    ...
    public static int CVehicle_SirenDataOffset { get; private set; }
    ...
    public static bool Init()
    {
        ...
        if (AssertAddress(address, nameof(CVehicle_AudVehicleAudioEntity)))
        {
            ...
            $"  CVehicle_AudVehicleAudioEntity = {CVehicle_AudVehicleAudioEntity:X}".ToLog();
        }
        ...
        if (AssertAddress(address, nameof(CVehicle_SequentialSirenPressesOffset)))
        {
            ...
            $"  CVehicle_SequentialSirenPressesOffset = {CVehicle_SequentialSirenPressesOffset:X}".ToLog();
        }
        
        address = Game.FindPattern("8B ?? ?? 00 00 48 85 C9 74 ?? 48 8B D3 E8 ?? ?? ?? FF 48");
        if (AssertAddress(address, nameof(CVehicle_SirenDataOffset)))
        {
            CVehicle_SirenDataOffset = Marshal.ReadInt32(address + 1);
            $"  CVehicle_SirenDataOffset = {CVehicle_SirenDataOffset:X}".ToLog();
        }
        ...
        if (AssertAddress(address, nameof(audVehicleAudioEntity_SirenStateOffset)))
        {
            ...
            $"  audVehicleAudioEntity_SirenStateOffset = {audVehicleAudioEntity_SirenStateOffset:X}".ToLog();
        }
        ...
        if (AssertAddress(address, nameof(audVehicleAudioEntity_SirenTimeOffset)))
        {
            ...
            $"  audVehicleAudioEntity_SirenTimeOffset = {audVehicleAudioEntity_SirenTimeOffset:X}".ToLog();
        }
        ...
        if (AssertAddress(address, nameof(audVehicleAudioEntity_LastSirenChangeTimeOffset)))
        {
            ...
            $"  audVehicleAudioEntity_LastSirenChangeTimeOffset = {audVehicleAudioEntity_LastSirenChangeTimeOffset:X}".ToLog();
        }
        ...
        if (AssertAddress(address, nameof(audVehicleAudioEntity_SirenSoundsOffset)))
        {
            ...
            $"  audVehicleAudioEntity_SirenSoundsOffset = {audVehicleAudioEntity_SirenSoundsOffset:X}".ToLog();
        }
